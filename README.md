...
### Key Features
* **Modern & Responsive Layout:** Clean UI with adaptive layouts for mobile, tablet, and desktop views.
* **Interactive Sections:** Dedicated blocks highlighting technical skill tags, education credentials, certifications, and experience timelines.
* **Contact Integration:** Functional contact form powered by Web3Forms for direct email messaging without a heavy backend.
* **Optimized UI Elements:** Custom badges, tags for key data capabilities (SQL, Power BI, Python, DAX), and interactive hover states.
